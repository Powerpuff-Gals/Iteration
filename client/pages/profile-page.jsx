      ...
      <div className="flex justify-center">
        <div className="max-w-md w-full z-10 bg-white rounded-xl shadow-2xl p-6 bg-blue-200">
          ...
          <img
            ...
            className="h-5 w-5 inline-block ml-[93%] mt-[-13%]"
          ...
          <div className="flex justify-center mt-4">
            <button
              ...
              className="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-50 hover:text-blue-500 w-auto h-9"
            >
              Update Profile
            </button>
          </div>
